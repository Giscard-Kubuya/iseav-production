  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      content:
        "Bonjour, nous vous invitons à participer à la réunion pédagogique de ce vendredi à 15h00 en salle des professeurs.",
      date: "2024-01-15",
      read: false,
      priority: "high",
    },
    {
      ...
      content:
        "Le nouveau règlement intérieur est disponible. Merci de le consulter et de confirmer votre lecture.",
      date: "2024-01-14",
      read: true,
      priority: "normal",
    },
    {
      ...
      content:
        "Votre fiche de paie du mois de janvier est disponible dans vos documents.",
      date: "2024-01-12",
      read: true,
      priority: "normal",
    },
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <Link href="/" className="text-2xl font-bold text-blue-600">
                Projet 8e CEPAC Beni Dashboard
              </Link>
