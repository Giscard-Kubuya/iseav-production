  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      category: "technology",
      excerpt:
        "Découvrez les innovations qui vont transformer le paysage technologique burundais en 2025.",
      content: `
    ...
    },
    {
      ...
      category: "security",
      excerpt:
        "Guide complet pour protéger votre entreprise contre les cybermenaces modernes.",
      content: `
    ...
    },
    {
      ...
      excerpt:
        "Les meilleures pratiques pour créer des applications mobiles performantes et user-friendly.",
      content: `
  ...
  const mockComments: Comment[] = [
    {
      ...
      content:
        "Excellent article ! Ces tendances sont très pertinentes pour le contexte burundais. Merci pour ces insights.",
      ...
      replies: [
        {
          ...
          content:
            "Merci Marie ! N'hésitez pas si vous avez des questions spécifiques sur l'implémentation de ces technologies.",
          date: "16 Janvier 2025",
        },
      ],
    },
    {
      ...
      content:
        "Très intéressant ! Nous cherchons justement à implémenter des solutions IoT dans notre exploitation agricole. Pouvez-vous nous aider ?",
                      ...
                      {comment.replies && comment.replies.length > 0 && (
                        <div className="ml-6 mt-4 space-y-4">
                          {comment.replies.map((reply) => (
                            <div
                              key={reply.id}
                              className="flex items-start space-x-4 border-l-2 border-blue-200 pl-4"
                            >
