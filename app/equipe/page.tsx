  ...
  if (loading) {
    return (
      <PageSEO
        ...
        description="Découvrez l'équipe dirigeante et les professionnels du 8e CEPAC Projet-Beni. Des experts dévoués à l'excellence dans le développement communautaire."
        keywords="équipe, dirigeants, CEPAC, leadership, professionnels, RDC, République Démocratique du Congo"
      >
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto">
                Une équipe de professionnels expérimentés dévoués à l'excellence dans le développement communautaire et au service de nos missions
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Des leaders expérimentés et passionnés, engagés dans l'excellence de nos missions et le développement communautaire
              </p>
            </div>
            ...
            {error ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 text-lg mb-4">Erreur lors du chargement de l'équipe</p>
                <button 
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 text-lg">Notre équipe sera bientôt présentée</p>
              </div>
            ) : (
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Les valeurs qui nous unissent et nous guident dans notre mission de développement communautaire
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-green-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Rejoignez Notre Mission</h2>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Vous partagez notre passion pour le développement communautaire ? Découvrez comment contribuer à nos programmes et rejoindre notre équipe d'experts.
            </p>
