...
export default function SettingsManagement() {
  ...
  const getDefaultSettings = (): SiteSettings => ({
    ...
    legal: {
      privacyPolicy:
        "Notre politique de confidentialité protège vos données personnelles selon les normes internationales.",
      termsOfService:
        "Nos conditions d'utilisation définissent les règles d'usage de nos services.",
    },
    security: {
    ...
    if (websiteData?.data) {
      ...
      setSettings({
        general: {
          ...
          siteDescription:
            apiData.description ||
            "Solutions informatiques innovantes au Burundi",
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("general", "mission", e.target.value)
                    }
                    rows={3}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    La mission définit le but et les objectifs de votre
                    entreprise.
                  </p>
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("general", "vision", e.target.value)
                    }
                    rows={3}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  />
                  <p className="mt-1 text-sm text-gray-500">
                    La vision décrit où vous voyez votre entreprise dans le
                    futur.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-gray-500">
                    Décrivez comment vous collectez, utilisez et protégez les
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-gray-500">
                    Définissez les règles et conditions d'utilisation de vos
                    services.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label
                      htmlFor="enableCommentModeration"
                      className="ml-2 block text-sm text-gray-900"
                    >
