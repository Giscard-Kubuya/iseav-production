...
const positions: Position[] = [
  {
    ...
    type: "Temps plein",
    description:
      "Nous recherchons des enseignants passionnés pour accompagner nos élèves du primaire dans leur apprentissage et leur développement intégral.",
    requirements: [
  ...
  },
  {
    ...
    type: "Temps plein",
    description:
      "Poste d'enseignant pour le cycle complémentaire avec spécialisation dans une matière spécifique.",
    requirements: [
  ...
  },
  {
    ...
    type: "Temps plein",
    description:
      "Poste de direction pour seconder le directeur dans la gestion quotidienne de l'établissement.",
    requirements: [
  ...
  },
  {
    ...
    type: "Temps plein",
    description:
      "Poste de secrétariat pour assurer la gestion administrative efficace de l'établissement.",
    requirements: [
  ...
  },
  {
    ...
    type: "Temps plein",
    description:
      "Poste de surveillance pour assurer l'encadrement bienveillant et la discipline des élèves.",
    requirements: [
  ...
  },
  {
    ...
    type: "Temps plein",
    description:
      "Poste comptable pour assurer une gestion financière rigoureuse de l'établissement.",
    requirements: [
        ...
        <section className="py-20 bg-gradient-to-r from-blue-800 to-amber-600 text-white">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto mb-8">
              Contribuez à l'excellence éducative au CEPAC et façonnez l'avenir
              de l'éducation au Bénin
            </p>
              ...
              <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                  <h2 className="text-4xl font-bold text-gray-900 mb-4">
                    Pourquoi Nous{" "}
                    <span className="text-amber-600">Rejoindre ?</span>
                  </h2>
                  <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    Des avantages qui font la différence pour votre
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center p-8 rounded-xl bg-blue-50 hover:shadow-lg transition-shadow">
                    ...
                    <p className="text-gray-600">
                      Participez à une mission éducative qui transforme des vies
                  ...
                  <div className="text-center p-8 rounded-xl bg-amber-50 hover:shadow-lg transition-shadow">
                    ...
                    <p className="text-gray-600">
                      Formations continues, mentorat et opportunités d'évolution
                      de carrière
                    </p>
                  </div>
                  ...
                  <div className="text-center p-8 rounded-xl bg-blue-50 hover:shadow-lg transition-shadow">
                    ...
                    <p className="text-gray-600">
                      Travaillez avec une équipe passionnée dans un
            ...
            <section id="positions" className="py-20">
              <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                  ...
                  <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                    Découvrez les opportunités de carrière qui correspondent à
                    vos compétences
                  </p>
                </div>
                          ...
                          <ul className="text-sm text-gray-600 space-y-1">
                            ...
                            {position.requirements.length > 2 && (
                              <li className="text-blue-600 font-medium">
                                +{position.requirements.length - 2} autres
                                exigences
                              </li>
                            )}
                          </ul>
          ...
          <section className="py-20">
            <div className="max-w-4xl mx-auto px-4">
              <div className="bg-white rounded-xl shadow-xl p-8">
                ...
                {/* Social Share for Job Position */}
                <div className="mb-8">
                  <SocialShare
                    url={
                      typeof window !== "undefined"
                        ? window.location.href
                        : `https://yoursite.com/recrutement#${selectedPosition.id}`
                    }
                    title={`Offre d'emploi: ${selectedPosition.title} - Projet 8e CEPAC Beni`}
                    description={`${selectedPosition.description} - Département: ${selectedPosition.department}`}
                    hashtags={[
                      "CEPAC",
                      "Emploi",
                      "Recrutement",
                    ...
                    // All social media enabled by default for recruitment posts
                    shareFacebook={true}
                    shareTwitter={true}
                    shareLinkedin={true}
                    shareWhatsapp={true}
          ...
          <section className="py-20 bg-gradient-to-r from-blue-800 to-amber-600 text-white">
            <div className="max-w-7xl mx-auto px-4 text-center">
              ...
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                Envoyez-nous votre candidature spontanée. Nous sommes toujours à
                la recherche de talents exceptionnels pour rejoindre notre
                équipe éducative.
              </p>
              <a
                href="/contact"
