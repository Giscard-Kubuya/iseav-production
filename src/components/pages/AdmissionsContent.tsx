  ...
  const admissionSteps = [
    {
      ...
      description:
        "Remplissez le formulaire de candidature et téléchargez vos documents",
      icon: "📝",
      duration: "15-30 min",
      details: [
    ...
    },
    {
      ...
      description:
        "Notre commission examine votre parcours et vos qualifications",
      icon: "🔍",
      duration: "5-7 jours",
      details: [
  ...
  const stats = [
    {
      ...
      value: "78%",
      icon: "📊",
      description: "Candidatures acceptées en 2023",
    },
    {
    ...
    },
    {
      ...
      value: "€450K",
      icon: "💰",
      description: "Soutien financier total",
    },
    {
          ...
          <div className="max-w-7xl mx-auto px-4 w-full">
            ...
            >
              ...
              <p className="text-lg md:text-xl lg:text-2xl mb-10 max-w-4xl mx-auto leading-relaxed text-gray-200 animate-fade-in-up delay-400">
                Découvrez comment intégrer ISEAV-ARU et transformer votre
                passion en expertise. Un processus d'admission transparent et
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Un parcours en 4 étapes simples pour rejoindre notre communauté
              d'excellence
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute top-24 left-8 md:left-1/2 md:transform md:-translate-x-1/2 w-1 md:w-full md:h-1 h-full bg-gray-200 rounded-full">
              <div
                ...
                style={{
                  width:
                    currentStep >= 1 ? `${(currentStep / 4) * 100}%` : "0%",
                  height: "100%",
                }}
              ></div>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {admissionSteps.map((step, index) => (
                ...
                >
                  {/* Step Circle */}
                  <div
                    className={`relative w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center text-2xl font-bold transition-all duration-500 ${
                  ...
                  >
                    ...
                    <div className="text-sm font-semibold text-cyan-600 mb-4">
                      ⏱️ {step.duration}
                    </div>
            ...
            {filteredRequirements.map((req, index) => (
              ...
              >
                ...
                <div className={`p-8 bg-gradient-to-r ${req.color} text-white`}>
                  ...
                  <div className="text-white/90">Frais: {req.fees.tuition}</div>
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div>
                        ...
                        <div className="font-semibold text-orange-600">
                          {req.deadlines.application}
                        </div>
                      </div>
                      <div>
                        <div className="text-gray-500">Documents</div>
                        <div className="font-semibold text-orange-600">
                          {req.deadlines.documents}
                        </div>
                      </div>
                      <div>
                        ...
                        <div className="font-semibold text-orange-600">
                          {req.deadlines.tests ||
                            req.deadlines.interviews ||
                            req.deadlines.defense}
                        </div>
                      </div>
                      <div>
                        <div className="text-gray-500">Résultats</div>
                        <div className="font-semibold text-green-600">
                          {req.deadlines.results}
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Nous soutenons l'excellence académique avec des programmes de
              bourses généreux
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {scholarships.map((scholarship, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 mx-auto mb-6 bg-gradient-to-r ${scholarship.color} rounded-full flex items-center justify-center text-2xl group-hover:rotate-12 transition-transform duration-500`}
                >
                  {scholarship.icon}
                </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 via-purple-600 to-amber-500">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-10 max-w-4xl mx-auto leading-relaxed">
            Rejoignez une communauté d'excellence où l'innovation, la recherche
            et l'entrepreneuriat se rencontrent pour créer les leaders de
            demain.
          </p>
