    ...
    try {
      ...
      try {
        ...
        if (apiError.response?.status === 401) {
          ...
          const demoAccounts = [
            {
              email: "admin@cepac-beni.org",
              password: "admin123",
              role: "admin",
              name: "Administrateur CEPAC",
            },
            {
          ...
          if (demoUser) {
            const userObj = {
              ...
              avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(
                demoUser.name
              )}&background=059669&color=white&size=256`,
            };
            ...
            setSuccessMessage(
              "Connexion démo réussie! Redirection en cours..."
            );
            ...
            setError({
              ...
              details:
                "API non disponible. Utilisez les comptes démo ci-dessous.",
            });
          }
        } else {
          setError({
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="mt-6 text-3xl font-bold text-white">
            Administration CEPAC
          </h1>
          <p className="mt-2 text-blue-200">
            8e CEPAC Projet-Beni - Organisation Non Gouvernementale
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
              <div
                className={`bg-${getErrorColor(
                  error.type
                )}-50 border border-${getErrorColor(
                  error.type
                )}-200 text-${getErrorColor(
                  error.type
                )}-700 px-4 py-3 rounded-lg`}
              >
        ...
        {/* Demo Accounts Info */}
        <div className="bg-blue-800/30 backdrop-blur-sm border border-blue-300/30 rounded-lg p-4 text-white hidden">
