  ...
  const faculties = [
    {
      ...
      email: 'a.mwanza@iseav-walungu.edu.cd',
    ...
    },
    {
      ...
      email: 'm.furaha@iseav-walungu.edu.cd',
    ...
    },
    {
      ...
      email: 'g.kahindo@iseav-walungu.edu.cd',
    ...
    },
    {
      ...
      email: 'jc.mukendi@iseav-walungu.edu.cd',
    ...
    },
    {
      ...
      email: 'e.nyota@iseav-walungu.edu.cd',
    ...
    },
    {
      ...
      email: 'p.balegamire@iseav-walungu.edu.cd',
    ...
    },
    {
      id: 8,
      department: 'research',
      name: 'Pr. Dieudonne Cibambo',
      title: 'Vice-Recteur Recherche',
      specialization: 'Économie Agricole & Développement',
      education: 'PhD Économie Agricole, Université de Lubumbashi',
      ...
      email: 'd.cibambo@iseav-walungu.edu.cd',
