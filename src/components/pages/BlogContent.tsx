...
export default function BlogContent() {
  ...
  const { blogPosts, loading, error } = useBlogPostsFront({
  ...
  const featuredArticles =
    blogPosts.filter((article) => article.featured) || [];
    ...
    <>
      ...
      <section className="relative h-[70vh] overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://images.unsplash.com/photo-1499750310107-5fef28a66643?ixlib=rb-4.0.3&auto=format&fit=crop&w=2940&q=80)",
          }}
        />
          ...
          <div className="max-w-7xl mx-auto px-4 w-full">
            <div className="text-center text-white">
              ...
              <p className="text-lg md:text-xl lg:text-2xl mb-10 max-w-4xl mx-auto leading-relaxed text-gray-200 animate-fade-in-up delay-400">
                Restez informés de nos activités et des enjeux du développement
                communautaire
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-green-500">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Recevez nos dernières actualités et informations sur nos projets
            communautaires directement dans votre boîte mail
          </p>
