        ...
        <div className="bg-blue-700 text-white text-sm py-2 hidden lg:block">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              {(websiteConfig?.social_media?.youtube ||
                websiteConfig?.social?.youtube ||
                websiteConfig?.settings?.social?.youtube) && (
                <a
                  href={
                    websiteConfig?.social_media?.youtube ||
                    websiteConfig?.social?.youtube ||
              ...
              {(websiteConfig?.social_media?.whatsapp ||
                websiteConfig?.social?.whatsapp ||
                websiteConfig?.settings?.social?.whatsapp) && (
                <a
                  href={
                    websiteConfig?.social_media?.whatsapp ||
                    websiteConfig?.social?.whatsapp ||
      ...
      <footer className="bg-gradient-to-r from-blue-900 via-blue-800 to-amber-700 text-white">
        <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-blue-100 leading-relaxed">
                {websiteConfig?.description ||
                  websiteConfig?.settings?.general?.siteDescription ||
              ...
              <div className="space-y-2 text-blue-100">
                <p>
                  ...
                  {websiteConfig?.address ||
                    websiteConfig?.settings?.address ||
                    websiteConfig?.general?.address ||
                    "Projet-Beni, République Démocratique du Congo"}
                </p>
                <p>
                  📞{" "}
          ...
          <div className="border-t border-blue-700 mt-8 pt-8 text-center text-blue-200">
            <p>
              {websiteConfig?.settings?.appearance?.footerText ||
                websiteConfig?.appearance?.footerText ||
