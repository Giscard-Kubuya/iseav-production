  ...
  return (
    <div>
      <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 lg:mb-6">
        Tableau de Bord - Projet 8e CEPAC Beni
      </h1>
      <p className="text-sm lg:text-base text-gray-600 mb-6 lg:mb-8">
        Organisation Non Gouvernementale - République Démocratique du Congo
      </p>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-4 lg:p-6">
          ...
          <div className="space-y-2">
            <a
              ...
              className="flex items-center p-3 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors text-sm lg:text-base"
            >
            ...
            <a
              ...
              className="flex items-center p-3 text-green-600 hover:bg-green-50 rounded-lg transition-colors text-sm lg:text-base"
            >
              <span className="mr-3 text-lg">👨‍💼</span>
            ...
            <a
              href="/admin/galerie"
              className="flex items-center p-3 text-purple-600 hover:bg-purple-50 rounded-lg transition-colors text-sm lg:text-base"
            >
              <span className="mr-3 text-lg">📸</span>
              Gérer la galerie
            </a>
