          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
              ...
              <div className="flex space-x-4">
                ...
                {(websiteConfig?.social_media?.linkedin || websiteConfig?.social?.linkedin || websiteConfig?.settings?.social?.linkedin) && (
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center group-hover:bg-blue-800 transition-all duration-300 group-hover:scale-110">
                      <svg
                        className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors duration-300"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                ...
                {(websiteConfig?.social_media?.github || websiteConfig?.social?.github || websiteConfig?.settings?.social?.github) && (
                  <a
                    ...
                    rel="noopener noreferrer"
                  >
                    <div className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center group-hover:bg-gray-700 transition-all duration-300 group-hover:scale-110">
                      <svg
                        className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors duration-300"
                        fill="currentColor"
                        viewBox="0 0 24 24"
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start group">
                  <svg
                    className="w-5 h-5 text-blue-400 mr-3 mt-1 group-hover:scale-110 transition-transform duration-300"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <div className="flex items-center group">
                  <svg
                    className="w-5 h-5 text-blue-400 mr-3 group-hover:scale-110 transition-transform duration-300"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Recevez nos insights technologiques et actualités IT directement
