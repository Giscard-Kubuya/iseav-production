      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            {mode === 'create' ? 'Nouvelle Diapositive Hero' : 'Modifier la Diapositive'}
          </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Primary Action */}
            <div>
              <label htmlFor="primary_action_text" className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <input
                ...
                onChange={(e) => handleInputChange('primary_action_text', e.target.value)}
            ...
            <div>
              <label htmlFor="primary_action_url" className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <input
                ...
                onChange={(e) => handleInputChange('primary_action_url', e.target.value)}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="/contact"
              />
            </div>
            ...
            {/* Secondary Action */}
            <div>
              <label htmlFor="secondary_action_text" className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <input
                ...
                onChange={(e) => handleInputChange('secondary_action_text', e.target.value)}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div>
              <label htmlFor="secondary_action_url" className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <input
                ...
                onChange={(e) => handleInputChange('secondary_action_url', e.target.value)}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
