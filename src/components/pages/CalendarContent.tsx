...
export default function CalendarContent() {
  ...
  const semesters = [
    {
      id: "current",
      name: "Semestre Actuel",
      period: "Septembre 2024 - Janvier 2025",
    },
    {
      id: "next",
      name: "Prochain Semestre",
  ...
  const academicEvents = [
    {
      ...
      description:
        "Début officiel de l'année académique pour tous les programmes",
      color: "from-blue-500 to-indigo-600",
      icon: "🎓",
    },
    {
    ...
    },
    {
      ...
      description:
        "Exposition des projets étudiants et innovations technologiques",
      color: "from-purple-500 to-violet-600",
      icon: "🚀",
    },
    {
    ...
    },
    {
      ...
      description:
        "Période de stage obligatoire pour les étudiants de 3ème année",
      color: "from-blue-500 to-indigo-600",
      icon: "💼",
    },
    {
          ...
          <div className="max-w-7xl mx-auto px-4 w-full">
            ...
            >
              ...
              <p className="text-lg md:text-xl lg:text-2xl mb-8 max-w-4xl mx-auto leading-relaxed text-gray-200 animate-fade-in-up delay-400">
                Consultez toutes les dates importantes, événements académiques
                et échéances pour une année universitaire parfaitement
                organisée.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Calendrier détaillé des événements, examens et dates importantes
                ...
                >
                  ...
                  <div
                    className={`group w-full md:w-5/12 ${
                      index % 2 === 0
                        ? "md:mr-auto md:pr-16 ml-20 md:ml-0"
                        : "md:ml-auto md:pl-16 ml-20 md:ml-0"
                    }`}
                  >
                    <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 overflow-hidden">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex justify-between items-center">
                          <span
                            className={`px-3 py-1 bg-gradient-to-r ${event.color} text-white rounded-full text-sm font-medium`}
                          >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Accédez rapidement aux services et informations académiques
              essentiels
            </p>
          </div>
            ...
            {[
              ...
              >
                <div className="text-center transform hover:scale-105 transition-all duration-300 bg-gray-800 hover:bg-gray-700 rounded-2xl p-6 border border-gray-700 hover:border-cyan-500">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 bg-gradient-to-r ${action.color} rounded-full flex items-center justify-center text-2xl group-hover:rotate-12 transition-transform duration-300`}
                  >
                    {action.icon}
                  </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-amber-500">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Abonnez-vous aux notifications pour recevoir les mises à jour
            importantes du calendrier académique directement dans votre
            messagerie.
          </p>
